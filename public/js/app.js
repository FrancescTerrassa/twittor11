...
// fa que no registri en sw fins que la pagina estigui carregada totalment
...
notificarme = () => {
    if (!window.Notification) {
        console.log('este navegador no soporta noticiaciones')
        return
    }

    if (Notification.perimission === 'granted') {
